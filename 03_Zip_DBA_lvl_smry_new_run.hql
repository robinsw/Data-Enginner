...
drop table if exists jg_zip_Mrch_Hotels_dba_combined;
create table jg_zip_Mrch_Hotels_dba_combined STORED AS SEQUENCEFILE as select
...
---==========================================================================================;
drop table if exists jg_mrch_db_zip_lvl_Hotels_dba_0_miles;
create table jg_mrch_db_zip_lvl_Hotels_dba_0_miles STORED AS SEQUENCEFILE as select distinct
	 corporation
	,mrch_dba_nm
	,industry
	,rollup_level
...
drop table if exists jg_mrch_db_zip_lvl_Hotels_0_miles_dba;
create table jg_mrch_db_zip_lvl_Hotels_0_miles_dba STORED AS SEQUENCEFILE as select 
	a.*
	,b.Mrch_zip_radious
	,b.crd_cnt_merch
	,b.us_tran_amt_merch
...
from jg_mrch_db_zip_lvl_Hotels_dba_0_miles a 
left outer join jg_zip_Mrch_Hotels_dba_combined b
on  a.corporation = b.corporation
and a.mrch_dba_nm = b.mrch_dba_nm
...
drop table if exists jg_mrch_db_zip_lvl_Hotels_mcc_dba_0_miles;
create table jg_mrch_db_zip_lvl_Hotels_mcc_dba_0_miles STORED AS SEQUENCEFILE as select distinct
	industry
	,rollup_level
	,month_updated
	,population
...
drop table if exists jg_mrch_db_zip_lvl_Hotels_0_miles_dba_mcc;
create table jg_mrch_db_zip_lvl_Hotels_0_miles_dba_mcc STORED AS SEQUENCEFILE as select 
	a.*
	,b.Mrch_zip_radious
	,b.crd_cnt
	,b.us_tran_amt_mcc
...
from jg_mrch_db_zip_lvl_Hotels_mcc_dba_0_miles a 
...
---------------------------------------------------------------;
drop table if exists jg_zip_Mrch_Hotels_dba_preyear;
create table jg_zip_Mrch_Hotels_dba_preyear STORED AS SEQUENCEFILE as select * 
from jg_mrch_db_zip_lvl_Hotels_0_miles_dba
where Time_Period ='Year ended Jun15';

---- previous year values for growth calc mcc;
---------------------------------------------------------------;
drop table if exists jg_zip_Mrch_Hotels_mcc_preyear_dba;
create table jg_zip_Mrch_Hotels_mcc_preyear_dba STORED AS SEQUENCEFILE as select * 
from jg_mrch_db_zip_lvl_Hotels_0_miles_dba_mcc
where 

Time_Period ='Year ended Jun15';

drop table if exists jg_zip_dba_list;
create table jg_zip_dba_list STORED AS SEQUENCEFILE as select distinct industry,Corporation,mrch_dba_nm from jg_MOR_details_Hotels;

drop table if exists jg_zip_Mrch_Hotels_mcc_dba_combined_crt_prdt;
create table jg_zip_Mrch_Hotels_mcc_dba_combined_crt_prdt STORED AS SEQUENCEFILE as
select a.*,b.Corporation,b.mrch_dba_nm from jg_mrch_db_zip_lvl_Hotels_0_miles_dba_mcc a join jg_zip_dba_list b
...
-------------------------------------------------------------;
drop table if exists jg_zip_Mrch_Hotels_mcc_dba_combined_w_merch_and_preyr_var;
create table jg_zip_Mrch_Hotels_mcc_dba_combined_w_merch_and_preyr_var STORED AS SEQUENCEFILE as select 
	a.industry,
	a.Product_Type,
	a.Platform,
	'a. Merchant' as Population,
...
from jg_zip_Mrch_Hotels_mcc_dba_combined_crt_prdt a 
left outer join jg_mrch_db_zip_lvl_Hotels_0_miles_dba b	
on trim(a.Product_Type) = trim(b.Product_Type)
	...
	and trim(a.mrch_dba_nm) = trim(b.mrch_dba_nm)
...
left outer join jg_zip_Mrch_Hotels_dba_preyear c
on trim(a.Product_Type) = trim(c.Product_Type)
	...
	and trim(a.mrch_dba_nm) = trim(c.mrch_dba_nm)
...
left outer join jg_zip_Mrch_Hotels_mcc_preyear_dba d
...
-- calculations;
-------------------------------------------------------------;
drop table if exists jg_zip_Mrch_Hotels_mcc_dba_combined_w_merch_and_preyr_var_w_calc;
create table jg_zip_Mrch_Hotels_mcc_dba_combined_w_merch_and_preyr_var_w_calc STORED AS SEQUENCEFILE as select
...
from jg_zip_Mrch_Hotels_mcc_dba_combined_w_merch_and_preyr_var;
